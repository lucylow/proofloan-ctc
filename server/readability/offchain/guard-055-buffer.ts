...
export class Guard055 {
  ...
  describe() {
    return { name:"Guard055", subject:"buffer", minimum:this.minimum, purpose:"buffer" };
  }
}

export function validateGuard055(value:number, minimum=14) {
  if (!Number.isFinite(value)) return false;
  return value >= minimum;
}

export function normalizeGuard055(value:number, minimum=14) {
  if (!Number.isFinite(value)) return minimum;
  return Math.max(minimum, value);
}

export function explainGuard055(value:number, minimum=14) {
