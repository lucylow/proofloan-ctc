...
export class Guard101 {
  ...
  describe() {
    return { name:"Guard101", subject:"lagBlocks", minimum:this.minimum, purpose:"lag" };
  }
}

export function validateGuard101(value:number, minimum=29) {
  if (!Number.isFinite(value)) return false;
  return value >= minimum;
}

export function normalizeGuard101(value:number, minimum=29) {
  if (!Number.isFinite(value)) return minimum;
  return Math.max(minimum, value);
}

export function explainGuard101(value:number, minimum=29) {
