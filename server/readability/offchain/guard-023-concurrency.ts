...
export class Guard023 {
  ...
  describe() {
    return { name:"Guard023", subject:"concurrency", minimum:this.minimum, purpose:"concurrency" };
  }
}

export function validateGuard023(value:number, minimum=10) {
  if (!Number.isFinite(value)) return false;
  return value >= minimum;
}

export function normalizeGuard023(value:number, minimum=10) {
  if (!Number.isFinite(value)) return minimum;
  return Math.max(minimum, value);
}

export function explainGuard023(value:number, minimum=10) {
