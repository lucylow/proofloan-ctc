...
export class Guard082 {
  ...
  describe() {
    return { name:"Guard082", subject:"capacity", minimum:this.minimum, purpose:"capacity" };
  }
}

export function validateGuard082(value:number, minimum=23) {
  if (!Number.isFinite(value)) return false;
  return value >= minimum;
}

export function normalizeGuard082(value:number, minimum=23) {
  if (!Number.isFinite(value)) return minimum;
  return Math.max(minimum, value);
}

export function explainGuard082(value:number, minimum=23) {
