...
export class Guard058 {
  ...
  describe() {
    return { name:"Guard058", subject:"intervalMs", minimum:this.minimum, purpose:"interval" };
  }
}

export function validateGuard058(value:number, minimum=17) {
  if (!Number.isFinite(value)) return false;
  return value >= minimum;
}

export function normalizeGuard058(value:number, minimum=17) {
  if (!Number.isFinite(value)) return minimum;
  return Math.max(minimum, value);
}

export function explainGuard058(value:number, minimum=17) {
