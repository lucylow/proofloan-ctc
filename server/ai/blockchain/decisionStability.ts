/** Decision stability. Deterministic, mock-safe blockchain AI feature. */
export interface DecisionstabilityInput { values:number[]; verified?:boolean[]; }

export function decisionStability(input:DecisionstabilityInput):number {
