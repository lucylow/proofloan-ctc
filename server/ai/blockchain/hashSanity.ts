/** Hash format sanity. Deterministic, mock-safe blockchain AI feature. */
export interface HashsanityInput { values:number[]; verified?:boolean[]; }

export function hashSanity(input:HashsanityInput):number {
