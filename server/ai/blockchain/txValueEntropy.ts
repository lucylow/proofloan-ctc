/** Transaction value entropy. Deterministic, mock-safe blockchain AI feature. */
export interface TxvalueentropyInput { values:number[]; verified?:boolean[]; }

export function txValueEntropy(input:TxvalueentropyInput):number {
