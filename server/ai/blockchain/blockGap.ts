/** Block gap signal. Deterministic, mock-safe blockchain AI feature. */
export interface BlockgapInput { values:number[]; verified?:boolean[]; }

export function blockGap(input:BlockgapInput):number {
