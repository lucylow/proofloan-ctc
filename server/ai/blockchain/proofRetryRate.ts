/** Proof retry rate. Deterministic, mock-safe blockchain AI feature. */
export interface ProofretryrateInput { values:number[]; verified?:boolean[]; }

export function proofRetryRate(input:ProofretryrateInput):number {
