/** Anomaly recency. Deterministic, mock-safe blockchain AI feature. */
export interface AnomalyrecencyInput { values:number[]; verified?:boolean[]; }

export function anomalyRecency(input:AnomalyrecencyInput):number {
