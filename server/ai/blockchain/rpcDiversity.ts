/** RPC source diversity. Deterministic, mock-safe blockchain AI feature. */
export interface RpcdiversityInput { values:number[]; verified?:boolean[]; }

export function rpcDiversity(input:RpcdiversityInput):number {
