/** Funding recency. Deterministic, mock-safe blockchain AI feature. */
export interface FundingrecencyInput { values:number[]; verified?:boolean[]; }

export function fundingRecency(input:FundingrecencyInput):number {
