/** Failed transaction rate. Deterministic, mock-safe blockchain AI feature. */
export interface FailedtxrateInput { values:number[]; verified?:boolean[]; }

export function failedTxRate(input:FailedtxrateInput):number {
