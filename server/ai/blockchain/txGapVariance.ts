/** Transaction timing variance. Deterministic, mock-safe blockchain AI feature. */
export interface TxgapvarianceInput { values:number[]; verified?:boolean[]; }

export function txGapVariance(input:TxgapvarianceInput):number {
