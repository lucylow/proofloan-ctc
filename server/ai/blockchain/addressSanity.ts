/** Address format sanity. Deterministic, mock-safe blockchain AI feature. */
export interface AddresssanityInput { values:number[]; verified?:boolean[]; }

export function addressSanity(input:AddresssanityInput):number {
