/** Reorg exposure. Deterministic, mock-safe blockchain AI feature. */
export interface ReorgsignalInput { values:number[]; verified?:boolean[]; }

export function reorgSignal(input:ReorgsignalInput):number {
