/** Asset entropy. Deterministic, mock-safe blockchain AI feature. */
export interface AssetentropyInput { values:number[]; verified?:boolean[]; }

export function assetEntropy(input:AssetentropyInput):number {
