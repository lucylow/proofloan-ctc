/** Evidence recency. Deterministic, mock-safe blockchain AI feature. */
export interface EvidencerecencyInput { values:number[]; verified?:boolean[]; }

export function evidenceRecency(input:EvidencerecencyInput):number {
