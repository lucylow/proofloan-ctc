/** Tail risk proxy. Deterministic, mock-safe blockchain AI feature. */
export interface TailriskInput { values:number[]; verified?:boolean[]; }

export function tailRisk(input:TailriskInput):number {
