/** Risk score margin. Deterministic, mock-safe blockchain AI feature. */
export interface ScoremarginInput { values:number[]; verified?:boolean[]; }

export function scoreMargin(input:ScoremarginInput):number {
