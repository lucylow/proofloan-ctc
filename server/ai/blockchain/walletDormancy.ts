/** Dormancy signal. Deterministic, mock-safe blockchain AI feature. */
export interface WalletdormancyInput { values:number[]; verified?:boolean[]; }

export function walletDormancy(input:WalletdormancyInput):number {
