/** Drawdown ratio. Deterministic, mock-safe blockchain AI feature. */
export interface DrawdownratioInput { values:number[]; verified?:boolean[]; }

export function drawdownRatio(input:DrawdownratioInput):number {
