/** Activity entropy. Deterministic, mock-safe blockchain AI feature. */
export interface ActivityentropyInput { values:number[]; verified?:boolean[]; }

export function activityEntropy(input:ActivityentropyInput):number {
