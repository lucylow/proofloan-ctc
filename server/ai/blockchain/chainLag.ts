/** Source chain lag. Deterministic, mock-safe blockchain AI feature. */
export interface ChainlagInput { values:number[]; verified?:boolean[]; }

export function chainLag(input:ChainlagInput):number {
