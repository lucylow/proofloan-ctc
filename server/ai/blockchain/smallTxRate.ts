/** Small transaction rate. Deterministic, mock-safe blockchain AI feature. */
export interface SmalltxrateInput { values:number[]; verified?:boolean[]; }

export function smallTxRate(input:SmalltxrateInput):number {
