...
exports.QueryBuilderForEvent = void 0;
const abi_utils_1 = require("./abi-utils");
class QueryBuilderForEvent {
    constructor(logOffset, log, logDescription) {
    ...
    addArgument(argumentName) {
        ...
        if (isTopic) {
            ...
            const dataComputedOffsets = (0, abi_utils_1.computeAbiOffsets)(this.logDescription.fragment.inputs.filter((t) => t.indexed == false), this.log.data);
...
exports.QueryBuilderForEvent = QueryBuilderForEvent;
