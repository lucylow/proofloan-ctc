...
class ApiClient {
    ...
    queryProofFor(chainKey, transactionHash) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const res = yield this.client.get(`${API_BASE_PATH}/${chainKey}/${transactionHash}`);
                return res.data;
            }
            catch (error) {
    ...
    queryProofBatchFor(chainKey, transactionHashes) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const res = yield this.client.post(`${API_BATCH_BASE_PATH}/${chainKey}`, transactionHashes);
                const data = res.data;
                const merkleProofs = new Map(Object.entries(data.merkleProofs).map(([headerNumber, proofsMap]) => [
                    Number(headerNumber),
                    new Map(Object.entries(proofsMap).map(([txIndex, proofEntry]) => [
                        Number(txIndex),
                        {
    ...
    queryAttestedHeight(chainKey) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const res = yield this.client.get(`${API_ATTESTED_HEIGHT_PATH}/${chainKey}`);
...
class ProofBuilder {
    ...
    getProof(transactionHash) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const continuityProof = yield this.client.queryProofFor(this.chainKey, transactionHash);
    ...
    getBatchProof(transactionHashes) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const continuityProof = yield this.client.queryProofBatchFor(this.chainKey, transactionHashes);
                return { success: true, data: continuityProof };
            }
            catch (error) {
     ...
     */
    waitUntilHeightAttested(chainKey_1, targetHeight_1) {
        return __awaiter(this, arguments, void 0, function* (chainKey, targetHeight, pollIntervalMs = 15000, waitTimeoutMs = 900000, // 15 minutes
        extraDelayMs = 5000) {
            ...
            while (true) {
                ...
                const latestAttestedHeight = yield this.client.queryAttestedHeight(chainKey);
                if (latestAttestedHeight == null) {
                    ...
                    yield new Promise((resolve) => setTimeout(resolve, extraDelayMs));
                    return;
                }
                else {
                    console.debug(`Height ${targetHeight} not yet attested and in proof builder service cache for chain key ${chainKey}. Latest height: ${latestAttestedHeight}. Retrying in ${pollIntervalMs}ms...`);
                }
...
exports.ProofBuilder = ProofBuilder;
